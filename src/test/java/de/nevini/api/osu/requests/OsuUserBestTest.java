...
public class OsuUserBestTest extends OsuApiProvider {
    ...
    public void testParser() throws IOException {
        OsuUserBestRequest request = OsuUserBestRequest.builder()
                .user("2")
                .build();
        List<OsuUserBest> result;
        ...
        Assert.assertArrayEquals(new OsuMod[]{OsuMod.SUDDEN_DEATH, OsuMod.PERFECT}, best.getMods());
        ...
        Assert.assertEquals(OsuRank.SS, best.getRank());
        Assert.assertEquals(Float.valueOf(70.2194f), best.getPp());
    }
