...
public class OsuScoreTest extends OsuApiProvider {
    ...
    public void testParser() throws IOException {
        OsuScoresRequest request = OsuScoresRequest.builder()
                .beatmapId(252002)
                .build();
        List<OsuScore> result;
        ...
        Assert.assertArrayEquals(new OsuMod[]{OsuMod.HIDDEN, OsuMod.HARD_ROCK}, score.getMods());
        ...
        Assert.assertEquals(OsuRank.SH, score.getRank());
        Assert.assertEquals(Float.valueOf(377.399f), score.getPp());
