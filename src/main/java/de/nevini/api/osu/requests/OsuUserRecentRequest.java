...
@Builder
@Value
public class OsuUserRecentRequest implements ApiRequest<List<OsuUserRecent>> {
    ...
    @Override
    public @NonNull ApiResponse<List<OsuUserRecent>> parseResponse(@NonNull Response response) {
    ...
    List<OsuUserRecent> parseStream(Reader reader) {
        Type type = new TypeToken<List<OsuUserRecent>>() {
        }.getType();
