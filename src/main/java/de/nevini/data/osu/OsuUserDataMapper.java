...
import de.nevini.jpa.osu.user.OsuUserData;

import static de.nevini.data.osu.OsuMapperUtils.convertDate;
import static de.nevini.data.osu.OsuMapperUtils.convertFloat;
