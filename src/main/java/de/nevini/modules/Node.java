...
public enum Node {
    ...
    LEGACY_GET_GAME("legacy.get.game", Module.LEGACY, Permissions.MANAGE_SERVER),
    ...
    LEGACY_SET_GAME("legacy.set.game", Module.LEGACY, Permissions.MANAGE_SERVER),
    ...
    LEGACY_UNSET_GAME("legacy.unset.game", Module.LEGACY, Permissions.MANAGE_SERVER),
