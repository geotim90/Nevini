...
(
    ...
    difficulty_aim       DOUBLE        NOT NULL,
    difficulty_speed     DOUBLE        NOT NULL,
    difficulty_size      DOUBLE        NOT NULL,
    difficulty_overall   DOUBLE        NOT NULL,
    difficulty_approach  DOUBLE        NOT NULL,
    difficulty_drain     DOUBLE        NOT NULL,
